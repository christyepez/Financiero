...
- Execution evidence: `docs/qa/financial-sprint-11-p4-execution-evidence.md`.
- Escalation follow-up: `docs/coordination/financial-sprint-11-p4-external-escalation-followup.md`.
