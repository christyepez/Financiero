...
public sealed class RuntimeSecurityTests : IClassFixture<FinancialApiFactory>
{
    ...
    [InlineData("GET", "/api/financial/purchases/productization-readiness")]
    [InlineData("GET", "/api/financial/purchases/00000000-0000-0000-0000-000000000001")]
    [InlineData("GET", "/api/financial/purchases/00000000-0000-0000-0000-000000000001/productization-readiness")]
    ...
    [InlineData("GET", "/api/financial/voided-documents/productization-readiness")]
    [InlineData("GET", "/api/financial/voided-documents/00000000-0000-0000-0000-000000000001")]
    [InlineData("GET", "/api/financial/voided-documents/00000000-0000-0000-0000-000000000001/productization-readiness")]
    ...
    [InlineData("GET", "/api/financial/portal-integration/readiness")]
    ...
    [InlineData("GET", "/api/financial/purchases/productization-readiness", "financial.electronicdocuments.read")]
    ...
    [InlineData("GET", "/api/financial/purchases/00000000-0000-0000-0000-000000000001/productization-readiness", "financial.electronicdocuments.read")]
    [InlineData("GET", "/api/financial/voided-documents?period=invalid", "financial.electronicdocuments.read")]
    [InlineData("GET", "/api/financial/voided-documents/productization-readiness", "financial.electronicdocuments.read")]
    ...
    [InlineData("GET", "/api/financial/voided-documents/00000000-0000-0000-0000-000000000001/productization-readiness", "financial.electronicdocuments.read")]
    ...
    [InlineData("GET", "/api/financial/portal-integration/readiness", "financial.electronicdocuments.read")]
